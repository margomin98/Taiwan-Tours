...
send.addEventListener('click', function (e) {
  ...
  axios.get(
      `https://ptx.transportdata.tw/MOTC/v2/Tourism/ScenicSpot?%24filter=contains(Address,'${keywordTxt}') 
...
`, {
    ...
    .then(function (response) {
     ...
     <div class="text">
    <p class="name">${item.ScenicSpotName} </p>
  <div class="description">${item.DescriptionDetail}</div>
